...
```mermaid
graph LR
title{Number of<br>Subdomains} --> subdomainsDate1[[Last Commit]] --> subdomainsNum1{{892909}}
title --> subdomainsDate2[[Currently]] --> subdomainsNum2{{893483}}
```
...
title --> 2xx[[2xx]] --> status2xxNum{{91382}}
title --> 3xx[[3xx]] --> status3xxNum{{1}}
title --> 4xx[[4xx]] --> status4xxNum{{550589}}
