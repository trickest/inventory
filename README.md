...
```mermaid
graph LR
title{Number of<br>Subdomains} --> subdomainsDate1[[Last Commit]] --> subdomainsNum1{{1456023}}
title --> subdomainsDate2[[Currently]] --> subdomainsNum2{{1458773}}
```
...
title --> 2xx[[2xx]] --> status2xxNum{{60175}}
title --> 3xx[[3xx]] --> status3xxNum{{1}}
title --> 4xx[[4xx]] --> status4xxNum{{293390}}
