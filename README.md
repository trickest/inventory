...
```mermaid
graph LR
title{Number of<br>Subdomains} --> subdomainsDate1[[Last Commit]] --> subdomainsNum1{{226779}}
title --> subdomainsDate2[[Currently]] --> subdomainsNum2{{232837}}
```
...
title --> 2xx[[2xx]] --> status2xxNum{{16889}}
title --> 3xx[[3xx]] --> status3xxNum{{1}}
title --> 4xx[[4xx]] --> status4xxNum{{69391}}
