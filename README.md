...
```mermaid
graph LR
title{Number of<br>Subdomains} --> subdomainsDate1[[Last Commit]] --> subdomainsNum1{{1013799}}
title --> subdomainsDate2[[Currently]] --> subdomainsNum2{{1031890}}
```
...
title --> 2xx[[2xx]] --> status2xxNum{{43782}}
title --> 3xx[[3xx]] --> status3xxNum{{1}}
title --> 4xx[[4xx]] --> status4xxNum{{151878}}
