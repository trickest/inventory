...
```mermaid
graph LR
title{Number of<br>Subdomains} --> subdomainsDate1[[Last Commit]] --> subdomainsNum1{{531655}}
title --> subdomainsDate2[[Currently]] --> subdomainsNum2{{531655}}
```
...
title --> 2xx[[2xx]] --> status2xxNum{{26631}}
title --> 3xx[[3xx]] --> status3xxNum{{1}}
title --> 4xx[[4xx]] --> status4xxNum{{105474}}
...
```mermaid
graph LR
title{5 Most Used<br>Technologies} --> tech1{{Nginx}}
title --> tech2{{Varnish}}
