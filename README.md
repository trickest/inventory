...
```mermaid
graph LR
title{Number of<br>Subdomains} --> subdomainsDate1[[Last Commit]] --> subdomainsNum1{{872703}}
title --> subdomainsDate2[[Currently]] --> subdomainsNum2{{876495}}
```
...
title --> 2xx[[2xx]] --> status2xxNum{{85909}}
title --> 3xx[[3xx]] --> status3xxNum{{1}}
title --> 4xx[[4xx]] --> status4xxNum{{542334}}
