...
```mermaid
graph LR
title{Number of<br>Subdomains} --> subdomainsDate1[[Last Commit]] --> subdomainsNum1{{137167}}
title --> subdomainsDate2[[Currently]] --> subdomainsNum2{{144345}}
```
...
title --> 2xx[[2xx]] --> status2xxNum{{7808}}
title --> 3xx[[3xx]] --> status3xxNum{{1}}
title --> 4xx[[4xx]] --> status4xxNum{{22155}}
