...
```mermaid
graph LR
title{Number of<br>Subdomains} --> subdomainsDate1[[Last Commit]] --> subdomainsNum1{{1085150}}
title --> subdomainsDate2[[Currently]] --> subdomainsNum2{{1090129}}
```
...
title --> 2xx[[2xx]] --> status2xxNum{{48563}}
